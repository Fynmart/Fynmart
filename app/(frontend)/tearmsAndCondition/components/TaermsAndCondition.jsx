      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <main className="p-6 space-y-6">
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold mb-3">Welcome to FynMart!</h2>
            <p className="text-gray-700">
              This website is operated by FynMart group. Throughout the site,
              the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer
              to FynMart group. FynMart group offers this website, including all
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">Terminology</h2>
            <p className="text-gray-700">
              The following terminology applies to these Terms and Conditions,
              Privacy Statement, and Disclaimer Notice, as well as all
              Agreements: &quot;Client&quot;, &quot;You&quot;, and
              &quot;Your&quot; refer to you, the person logging onto this
              website and compliant with the Company&apos;s terms and
              conditions. &quot;The Company&quot;, &quot;Ourselves&quot;,
              &quot;We&quot;, &quot;Our&quot;, and &quot;Us&quot; refer to our
              Company. &quot;Party&quot;, &quot;Parties&quot;, or &quot;Us&quot;
              refer to both the Client and ourselves. All terms refer to the
              ...
              Client&apos;s needs in respect of the provision of the
              Company&apos;s stated services, in accordance with and subject to
              the prevailing law of the Netherlands. Any use of the above
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">7. OPTIONAL TOOLS</h2>
            <p className="text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              any comments; or (3) to respond to any comments. We may, but have
              ...
              proprietary rights. You further agree that your comments will not
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">12. PROHIBITED USES</h2>
            <p className="text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              durability, title, and non-infringement. In no case shall FynMart
              group, our directors, officers, employees, affiliates, agents,
          ...
          <section>
            ...
            <p className="text-gray-700">
              You agree to indemnify, defend and hold harmless FynMart group and
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3">18. GOVERNING LAW</h2>
            <p className="text-gray-700">
        ...
        <footer className="bg-gray-200 p-6 text-center text-gray-600">
          <p>These Terms of Service were last updated on August 29, 2024.</p>
        </footer>
      </div>
    </div>
  );
...
export default TaermsAndCondition;
